...
namespace com.ootii.Cameras
{
    ...
    public class IndAdventureRig : CameraRig
    {
        ...
        /// </summary>
        public Vector3 _OrbitSpeed = new Vector3(90f, 180f, 90f);
        ...
        private bool HandleCollision(Vector3 rPosition, ref Vector3 rTargetPosition)
        {
            ...
            if (lCollisionHit)
            {
                ...
                if (!sCollisionInfo.collider.isTrigger && sCollisionInfo.collider.gameObject != _Anchor.gameObject)
                {
                    ...
                    float lDistance = NumberHelper.GetHorizontalDistance(sCollisionInfo.point, _Anchor.position);
