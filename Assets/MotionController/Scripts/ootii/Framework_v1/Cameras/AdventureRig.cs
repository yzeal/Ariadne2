...
namespace com.ootii.Cameras
{
    ...
    public class AdventureRig : CameraRig
    {
        ...
        /// </summary>
        public Vector3 _Pitch = new Vector3(4f, -60f, 70f);
        ...
        /// </summary>
        public Vector3 _RotationSpeed = new Vector3(360f, 1440f, 360f);
        ...
        public void Update()
        {
            ...
            if (mMode == EnumCameraMode.FIRST_PERSON)
            {
                ...
                _Yaw.x = NumberHelper.NormalizeAngle(_Yaw.x + Mathf.SmoothDampAngle(0, lViewX, ref mViewVelocityY, 0.2f));
                ...
                _Pitch.x = NumberHelper.NormalizeAngle(_Pitch.x - Mathf.SmoothDampAngle(0, lViewY, ref mViewVelocityX, 0.2f));
        ...
        public void ApplyMovement()
        {
            ...
            mSmoothPitchLerp = 1f;
            if (_UseSmoothMovement && lUseSmoothMovement)
            {
        ...
        private bool HandleCollision(Vector3 rPosition, ref Vector3 rTargetPosition)
        {
            ...
            if (lCollisionHit)
            {
                ...
                float lDistance = NumberHelper.GetHorizontalDistance(sCollisionInfo.point, _Controller.transform.position);
